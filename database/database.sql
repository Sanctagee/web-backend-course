...
-- ALTER TYPE public.account_type OWNER TO cse_340_sanctagee;
...
-- 5. Foreign key    in order to create a relationship between 'classification' table and 'inventory' table
...
-- 7. DATA FOR THE INVENTORY TABLE ARE INSERTED HERE
...
-- To insert the values that will fill the respective columns above
VALUES   (
    'Chevy',
    'Camaro',
    '2018',
