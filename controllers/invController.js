...
/* ***************************
 *  To Build inventory management view (Task1)
 * ************************** */
invCont.buildManagementView = async function (req, res, next) {
  ...
  res.render("./inventory/management", {
    ...
    nav,
    errors: null,
    classificationSelect // added as an update
  })
}

/* ***************************
 *  To build add classification view (Task 2)
 * ************************** */
...
/* ***************************
 *  To build add inventory view (Task 3)
 * ************************** */
